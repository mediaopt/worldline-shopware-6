            ...
            this.apiTest.check(this.pluginConfig).then((res) => {
                if (res.success) {
                    ...
                    this.createNotificationSuccess({
                        title: this.$tc('paymentPlugin.api-test-button.title'),
                        message: this.$tc('paymentPlugin.api-test-button.success')
                    });
                    document.querySelector('.sw-extension-config__save-action').click();
                } else {
                    this.createNotificationError({
                        title: this.$tc('paymentPlugin.api-test-button.title'),
                        message: this.$tc('paymentPlugin.api-test-button.error') + res.message
                    });
                }
